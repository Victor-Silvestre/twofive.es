...
<html>
  <head>
    <meta charset="utf-8">
    <title>TwoFive Gloves – 2020Lyon19Replica</title>
      ...
      <nav>
        ...
        <div id="menu">
          ...
          <ul>
            ...
            <li><a style="color:#bf6545" href="gloves-2020Lyon19Replica.php">Lyon'19</a></li>
            <li><a href="#section01">Características</a></li>
            <li id="buy-now"><a href="https://twofivegloves.com/shop/?product=2020-lyon19-replica">Compra online</a></li>
          </ul>
        </div>
      </nav>
      <div id="hero-section">
        <img src="lib/img/gloves/2020-Lyon19-Replica/2020-Lyon19-Replica.jpg" alt="">
        <div class="head-line-block">
          ...
          <a class="button-link spritetrigger" href="gloves-2020Lyon19Replica-360view.php" role="button">Vista 360°</a>
        </div>
        ...
        <div class="history-swiper swiper-container">
          <div class="swiper-wrapper">
             ...
             <div class="swiper-slide">
               <div class="img-frame">
                 <img src="lib/img/gloves/2020-Lyon19-Replica/2020Lyon19-Replica_palm.jpg" alt="">
               </div>
              ...
              <div class="swiper-slide">
                <div class="img-frame">
                  <img src="lib/img/gloves/2020-Lyon19-Replica/2020Lyon19-Replica_cut.jpg" alt="">
                </div>
                <div class="text-container">
                  <?php include 'templates/gloves-cut-rollflat.php';?>
                </div>
                <div class="drag-icon animate__animated animate__pulse"></div>
               </div>
               ...
               <div class="swiper-slide">
                 <div class="img-frame">
                   <img src="lib/img/gloves/2020-Lyon19-Replica/2020Lyon19-Replica_back.jpg" alt="">
                 </div>
                 <div class="text-container">
                ...
                <div class="swiper-slide">
                  <div class="img-frame">
                    <img src="lib/img/gloves/2020-Lyon19-Replica/2020Lyon19-Replica_wrist.jpg" alt="">
                  </div>
                  <div class="text-container">
