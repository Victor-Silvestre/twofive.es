...
<html>
  <head>
    <meta charset="utf-8">
    <title>TwoFive Gloves – 2021Basel08Pro</title>
      ...
      <nav>
        ...
        <div id="menu">
          ...
          <ul>
            ...
            <li><a style="color:#bf6545" href="gloves-2021Basel08Pro.php">Basel'08</a></li>
            <li><a href="#section01">Características</a></li>
            <li id="buy-now"><a href="https://twofivegloves.com/shop/?product=2021-basel08-pro">Compra online</a></li>
          </ul>
        </div>
      </nav>
      <div id="hero-section">
        <img src="lib/img/gloves/2021-Basel08-Pro/2021-Basel08-Pro.jpg" alt="">
        <div class="head-line-block">
          <p class="edition-statement">PRO EDITION</p>
          <h1 id="head-line"><span style="color:#bf6545;">#</span>Basel'08</h1>
          <a class="button-link spritetrigger" href="gloves-2021Basel08Pro-360view.php" role="button">Vista 360°</a>
        </div>
        ...
        <div class="history-swiper swiper-container">
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="img-frame">
                <img src="lib/img/gloves/2021-Basel08-Pro/2021Basel08-Pro_palm.jpg" alt="">
              </div>
             ...
             <div class="swiper-slide">
               <div class="img-frame">
                 <img src="lib/img/gloves/2021-Basel08-Pro/2021Basel08-Pro_cut.jpg" alt="">
               </div>
               <div class="text-container">
              ...
              <div class="swiper-slide">
                <div class="img-frame">
                  <img src="lib/img/gloves/2021-Basel08-Pro/2021Basel08-Pro_back.jpg" alt="">
                </div>
                <div class="text-container">
               ...
               <div class="swiper-slide">
                 <div class="img-frame">
                   <img src="lib/img/gloves/2021-Basel08-Pro/2021Basel08-Pro_wrist.jpg" alt="">
                 </div>
                 <div class="text-container">
                ...
                <div class="swiper-slide">
                  <div class="img-frame">
                    <img src="lib/img/gloves/2021-Basel08-Pro/2021Basel08-Pro_review.jpg" alt="">
                  </div>
                  <div class="text-container">
                    ...
                    <a href="https://twofivegloves.com/shop/?product=2021-basel08-pro" class="button-link">Compra ahora</a>
                  </div>
                </div>
