...
<html>
  <head>
    <meta charset="utf-8">
    <title>TwoFive Gloves – 2020Vienna08Replica</title>
  ...
  <body>
    ...
    <header style="background-image: linear-gradient(#FF6E9D, #FF6E9D);">
      <nav>
        <div id="brand">
          <div id="logo"></div>
        ...
        <div id="menu">
          ...
          <ul>
            ...
            <li><a style="color:#bf6545" href="gloves-2020Vienna08Replica.php">Vienna'08</a></li>
            <li><a href="#section01">Características</a></li>
            <li id="buy-now"><a href="https://twofivegloves.com/shop/?product=2020-vienna08-replica">Compra online</a></li>
          </ul>
        </div>
      </nav>
      <div id="hero-section">
        <img src="lib/img/gloves/2020-Vienna08-Replica/2020-Vienna08-Replica.jpg" alt="">
        <div class="head-line-block">
          ...
          <a class="button-link spritetrigger" href="gloves-2020Vienna08Replica-360view.php" role="button">Vista 360°</a>
        </div>
        ...
        <div class="history-swiper swiper-container">
          <div class="swiper-wrapper">
             ...
             <div class="swiper-slide">
               <div class="img-frame">
                 <img src="lib/img/gloves/2020-Vienna08-Replica/2020Vienna08-Replica_palm.jpg" alt="">
               </div>
              ...
              <div class="swiper-slide">
                <div class="img-frame">
                  <img src="lib/img/gloves/2020-Vienna08-Replica/2020Vienna08-Replica_cut.jpg" alt="">
                </div>
                <div class="text-container">
               ...
               <div class="swiper-slide">
                 <div class="img-frame">
                   <img src="lib/img/gloves/2020-Vienna08-Replica/2020Vienna08-Replica_back.jpg" alt="">
                 </div>
                 <div class="text-container">
                ...
                <div class="swiper-slide">
                  <div class="img-frame">
                    <img src="lib/img/gloves/2020-Vienna08-Replica/2020Vienna08-Replica_wrist.jpg" alt="">
                  </div>
                  <div class="text-container">
