...
<html style="height: 100%; overflow: hidden;">
  ...
  <body style="height: 100%; overflow: hidden;">
    ...
    <header style="background: #E4E8F4;">
      <nav>
        <div id="brand">
          <div id="logo"></div>
        ...
        <div id="menu">
          ...
          <ul>
            <li><a href="javascript:history.back()" class="backhome"><i class="fas fa-angle-left" style="padding-top:3px;"></i>Atrás</a></li>
          </ul>
        </div>
      </nav>
      <div id="hero-section">
        <div class="ss spritespin"></div>
    ...
    <script src="lib/js/spritespin_2020-Johannesburg10-Replica.js"></script>
