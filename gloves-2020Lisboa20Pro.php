...
<html>
  <head>
    <meta charset="utf-8">
    <title>TwoFive Gloves – 2020Lisboa20Pro</title>
  ...
  <body>
    ...
    <header style="background-image: linear-gradient(#ffffff,#0F3C91);">
      <nav>
        <div id="brand">
          <div id="logo"></div>
        ...
        <div id="menu">
          ...
          <ul>
            ...
            <li><a style="color:#bf6545" href="gloves-2020Lisboa20Pro.php">Lisboa'20</a></li>
            <li><a href="#section01">Características</a></li>
            <li id="buy-now"><a href="https://twofivegloves.com/shop/?product=2020-Lisboa20-pro">Compra online</a></li>
          </ul>
        </div>
      </nav>
      <div id="hero-section">
        <img src="lib/img/gloves/2020-Lisboa20-Pro/2020-Lisboa20-Pro.jpg" alt="">
        <div class="head-line-block">
          <p class="edition-statement">PRO EDITION</p>
          <h1 id="head-line"><span style="color:#bf6545;">#</span>Lisboa'20</h1>
          <a class="button-link spritetrigger" href="gloves-2020Lisboa20Pro-360view.php" role="button">Vista 360°</a>
        </div>
        ...
        <div class="history-swiper swiper-container">
          <div class="swiper-wrapper">
             ...
             <div class="swiper-slide">
               <div class="img-frame">
                 <img src="lib/img/gloves/2020-Lisboa20-Pro/2020Lisboa20-Pro_palm.jpg" alt="">
               </div>
              ...
              <div class="swiper-slide">
                <div class="img-frame">
                  <img src="lib/img/gloves/2020-Lisboa20-Pro/2020Lisboa20-Pro_cut.jpg" alt="">
                </div>
                  <div class="text-container">
               ...
               <div class="swiper-slide">
                 <div class="img-frame">
                   <img src="lib/img/gloves/2020-Lisboa20-Pro/2020Lisboa20-Pro_back.jpg" alt="">
                 </div>
                   <div class="text-container">
                ...
                <div class="swiper-slide">
                  <div class="img-frame">
                    <img src="lib/img/gloves/2020-Lisboa20-Pro/2020Lisboa20-Pro_wrist.jpg" alt="">
                  </div>
                  <div class="text-container">
                    <?php include 'templates/gloves-wrist-integrated.php';?>
                  </div>
